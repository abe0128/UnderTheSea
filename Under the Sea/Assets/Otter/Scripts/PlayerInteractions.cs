...
public class PlayerInteractions : MonoBehaviour
{
    ...
    private AudioSource audioSource;            // To hold the AudioSource component
    ...
    void Start()
    {
        ...
        audioSource = GetComponent<AudioSource>();                                                      // set the AudioSource component to audioSource
    }
    ...
    /// <summary>
    /// OnTriggerExit function, handles anything on trigger exit
    /// 1. If object is tagged as Wall, set it's trigger set to false, makes it a collision object instead.
    /// </summary>
    /// <param name="other"></param>
